...
ғᴏʀ ᴍᴏʀᴇ ᴅᴇᴛᴀɪʟs ᴜsᴇ ᴛʜᴇ ʙᴜᴛᴛᴏɴs ʙᴇʟᴏᴡ 🤞🏻</blockquote>

<blockquote>ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ 🔋 : <a href='https://telegram.me/SSK_MOVIES'>SSK_MOVIES</a></blockquote>
</b>"""
...
🙏🏻 ᴍʏ ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/K0UND1NYA'>~(SSK)</a>
🧑🏻‍💻 ʀᴇᴘᴏ : <a href="https://t.me/SSK_MOVIES">ʟɪɴᴋ</a>
</b>"""
...
ᴘʟᴇᴀsᴇ ᴊᴏɪɴ ᴏᴜʀ ʀᴇǫᴜᴇsᴛ ɢʀᴏᴜᴘ ᴛᴏ ɢᴇᴛ ✨</b>'''
    ...
    REF_LINK = '''🔗 <b>Hᴇʀᴇ ɪs ᴏᴜʀ ʀᴇғᴇʀʀᴀʟ ʟɪɴᴋ: <code>https://telegram.me/{}?start=SSK_MOVIES-{}</code>
...
"""
    ...
    FILE_CAPTION = """ɴᴀᴍᴇ : <a href='https://t.me/ssk_movies'><b>🥁{file_name}🫧</b></a>"""
...
🌐 Tɪᴍᴇᴢᴏɴᴇ : <code>Asia/Kolkata</code></b>"""
    ...
    🍁ɴᴏᴛᴇ : ɪғ ᴛʜɪs ᴍᴏᴠɪᴇ ɪs ᴀᴠᴀɪʟᴀʙʟᴇ ᴀɴᴅ ɴᴏᴛ ғᴏᴜɴᴅ ɪɴ ʙᴏᴛ ᴘʟᴇᴀsᴇ ɴᴏᴛɪғʏ ʜᴇʀᴇ <a href='https://t.me/talk_mrs_bot'>[ᴀᴅᴍɪɴ]</a></b>"""
...
‼️ ᴄʟɪᴄᴋ ᴏɴ ʙᴇʟᴏᴡ ʙᴜᴛᴛᴏɴ ᴛᴏ ᴄʜᴇᴄᴋ ᴀʟʟ ᴀᴠᴀɪʟᴀʙʟᴇ ᴘʟᴀɴs & ɪᴛ's ᴘʀɪᴄᴇs</b>"""
    ...
    BUY_PLAN = """<b>○ <u>ғɪʀsᴛ sᴛᴇᴘ</u> : ᴘᴀʏ ᴛʜᴇ ᴀᴍᴏᴜɴᴛ ᴀᴄᴄᴏʀᴅɪɴɢ ᴛᴏ ʏᴏᴜʀ ғᴀᴠᴏʀɪᴛᴇ ᴘʟᴀɴ ᴛᴏ ᴛʜɪs <code>paradox52693@okhdfcbank</code> ᴜᴘɪ ɪᴅ.
    
○ <u>secoɴᴅ sᴛᴇᴘ</u> : ᴛᴀᴋᴇ ᴀ sᴄʀᴇᴇɴsʜᴏᴛ ᴏғ ʏᴏᴜʀ ᴘᴀʏᴍᴇɴᴛ ᴀɴᴅ sʜᴀʀᴇ ɪᴛ ᴅɪʀᴇᴄᴛʟʏ ʜᴇʀᴇ: @talk_mrs_bot 
...
<code>/set_tutorial https://t.me/SSK_MOVIES</code>
...
<u>ʏᴏᴜ ʜᴀᴠᴇ ᴄᴏᴍᴘʟᴇᴛᴇᴅ ᴛʜᴇ 1st ᴠᴇʀɪꜰɪᴄᴀᴛɪᴏɴ ✓</u>
